                                ...
                                <div className="col-8">
                                    ...
                                    <div className="container">
                                        <div className="row justify-content-start">
                                            {/*<div className="col-md-9 text-justified">*/}
                                            <div className="text-justified">
                                                <p>I’m a Senior Product Manager working on AI code agent enablement, with over 10 years of experience building and leading cross-functional teams across productivity, fintech, and biomedical sectors. My focus is on turning complex AI systems into products that solve real user problems, scale in practice, and meaningfully improve how teams build software.</p>

                                                <p>Currently, I work at <a href="https://tessl.io" target="_blank">Tessl</a>, where I focus on agent skills and evaluation, and on understanding how context and environment shape agent behaviour across models and workflows. My work centres on measuring agent quality and building the foundations for more reliable, context-aware AI systems.</p>

                                                <p>Previously, I led the <a href="https://www.figma.com/blog/design-context-everywhere-you-build/" target="_blank">Code Connect</a> team at <a href="https://www.figma.com" target="_blank">Figma</a>, part of Dev Mode, an industry-leading product that links design systems and codebases, enabling teams to produce production-ready code from designs through code agents (powered by <a href="https://www.figma.com/blog/introducing-figmas-dev-mode-mcp-server/" target="_blank">Figma’s MCP Server</a>). As Figma's first non-US product hire, I overhauled and relaunched the product to better meet user needs and helped advance Figma’s goal of being at the heart of the design-to-production workflow. Additionally, I serve as a guest lecturer for the <a href="https://www.conceptionx.org/" target="_blank">ConceptionX</a> programme, supporting deep tech founders.</p>
